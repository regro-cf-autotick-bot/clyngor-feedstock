...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/clyngor-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=9520&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/clyngor-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `clyngor` can be installed with:

```
conda install clyngor
```

It is possible to list all of the versions of `clyngor` available on your platform with:
